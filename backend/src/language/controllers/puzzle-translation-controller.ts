...
export class PuzzleTranslationController {
  ...
  async createPuzzleTranslation(@Body() createDto) {
  ...
  @Patch("translate/:id")
  // @UseGuards(LanguageGuard)
  async updatePuzzleTranslation(@Param('id') id: string, @Body() updateDto) {
  ...
  // @UseGuards(LanguageGuard)
  async approvePuzzleTranslation(@Param('id') id: string, @Body() approveDto) {
